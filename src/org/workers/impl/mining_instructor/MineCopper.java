...
public class MineCopper extends TutorialWorker
{
	private static final Area COPPER_AREA = new Area(3081, 9497, 3095, 9505);
	
	public MineCopper(OrionTutorial mission)
	{
		super(mission);
	}
	...
	public void work()
	{
		script.log(this, false, "Mine Copper");
		int confCache = configs.get(TutorialState.CONFIG_ID);
		
		if(iFact.clickObject("Mine", "Rocks", COPPER_AREA).execute())
